...
/** Utility functions used by the Muusic Qt UI.
 */
namespace GUIUtil
{
...
// Render MUU addresses in monospace font
...
// Parse "muusic:" URI into recipient object, return true on successful parsing
