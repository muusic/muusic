...
{
    std::string genesisblockhash = "00000084de8d8a282b613bbfeb1a1e3b04c8f9b89e2e34b81cf997cf05847ad5";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (muusic.conf).");
            QMessageBox::warning(this, "Muusic Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
