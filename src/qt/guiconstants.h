...
/* Muusic GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Muusic"
#define QAPP_ORG_DOMAIN "muusic.co.in"
#define QAPP_APP_NAME_DEFAULT "Muusic-Qt"
#define QAPP_APP_NAME_TESTNET "Muusic-Qt-testnet"
