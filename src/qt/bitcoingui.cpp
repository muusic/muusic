                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Muusic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MUU address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and muusic: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Muusic Core"), this);
    aboutAction->setStatusTip(tr("Show information about Muusic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Muusic"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MUU addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MUU addresses"));
    ...
    openAction->setStatusTip(tr("Open a muusic: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Muusic Core help message to get a list with possible Muusic command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Muusic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Muusic network", "", count));
}
...
{
    QString strTitle = tr("Muusic Core"); // default title
