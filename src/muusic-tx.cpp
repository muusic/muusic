...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Muusic Core muusic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  muusic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded muusic transaction") + "\n" +
                               "  muusic-tx [options] -create [commands]   " + _("Create hex-encoded muusic transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded muusic transaction
