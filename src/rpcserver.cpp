...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Muusic features */
        {"muusic", "masternode", &masternode, true, true, false},
        {"muusic", "listmasternodes", &listmasternodes, true, true, false},
        {"muusic", "getmasternodecount", &getmasternodecount, true, true, false},
        {"muusic", "masternodeconnect", &masternodeconnect, true, true, false},
        {"muusic", "masternodecurrent", &masternodecurrent, true, true, false},
        {"muusic", "masternodedebug", &masternodedebug, true, true, false},
        {"muusic", "startmasternode", &startmasternode, true, true, false},
        {"muusic", "createmasternodekey", &createmasternodekey, true, true, false},
        {"muusic", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"muusic", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"muusic", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"muusic", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"muusic", "getmasternodescores", &getmasternodescores, true, true, false},
        {"muusic", "mnbudget", &mnbudget, true, true, false},
        {"muusic", "preparebudget", &preparebudget, true, true, false},
        {"muusic", "submitbudget", &submitbudget, true, true, false},
        {"muusic", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"muusic", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"muusic", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"muusic", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"muusic", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"muusic", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"muusic", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"muusic", "checkbudgets", &checkbudgets, true, true, false},
        {"muusic", "mnsync", &mnsync, true, true, false},
        {"muusic", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> muusic-cli " + methodname + " " + args + "\n";
}
