...
#   c) node1 mines 32 blocks, so now node 0 has 500000 MUU, node 1 has 4250 MUU, node2 has none.
#   d) node0 sends 601 MUU to node2, in two transactions (301 MUU, then 300 MUU).
