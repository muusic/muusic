...
RESOURCES += src/qt/muusic.qrc src/qt/muusic_locale.qrc

TRANSLATIONS += src/qt/locale/muusic_bg.ts \
                src/qt/locale/muusic_de.ts \
                src/qt/locale/muusic_en.ts \
                src/qt/locale/muusic_es.ts \
                src/qt/locale/muusic_fi.ts \
                src/qt/locale/muusic_fr.ts \
                src/qt/locale/muusic_it.ts \
                src/qt/locale/muusic_ja.ts \
                src/qt/locale/muusic_pl.ts \
                src/qt/locale/muusic_pt.ts \
                src/qt/locale/muusic_ru.ts \
                src/qt/locale/muusic_sk.ts \
                src/qt/locale/muusic_sv.ts \
                src/qt/locale/muusic_vi.ts \
                src/qt/locale/muusic_zh_CN.ts \
                src/qt/locale/muusic_zh_TW.ts
