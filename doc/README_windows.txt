...
Intro
-----
Muusic (MUU) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Muusic utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run muusic-qt.exe.

Muusic Core is the original Muusic client and it builds the backbone of the network.
However, it downloads and stores the entire history of Muusic transactions;
