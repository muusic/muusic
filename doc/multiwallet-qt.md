...
In order to support loading of multiple wallets in muusic-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is muusic.cpp.
...
Changes to muusic.cpp
----------------------
muusic.cpp is the entry point into muusic-qt, and as such, will require some minor modifications to provide hooks for
