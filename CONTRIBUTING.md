Contributing to Muusic Core
==================================

The Muusic Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Muusic Core project, and is not to be
confused with overall Muusic Network Protocol consensus changes.

Whether a pull request is merged into Muusic Core rests with the project merge
...
Patches that change Muusic consensus rules are considerably more involved than
...
Where a patch set proposes to change the Muusic consensus, it must have been
...
The project leader is the release manager for each Muusic Core release.
